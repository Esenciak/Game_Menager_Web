...
{
    /// <inheritdoc />
    public partial class AddHeroesToDbAndSeed : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Heroes",
                columns: new[] { "Id", "Age", "CreatedDateTime", "Description", "Dexterity", "Gender", "Gold", "HP", "Level", "Mana", "Name", "Race", "Skill", "Skill2", "Skill3", "Skill4", "SkillDescription", "SkillDescription2", "SkillDescription3", "SkillDescription4", "SkillRank", "SkillRank2", "SkillRank3", "SkillRank4", "Speed", "Strenght", "User", "Weapon" },
                values: new object[] { 1, 1200, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "elf pochodzący ze szczepu Sindarów. W Trzeciej Erze był członkiem Drużyny Pierścienia.", 100, "Male", 20, 70, 12, 20, "Legolas", "Elf", "Ciche kroki", "Szybkie strzelanie", "Wysoki skok", "Sokole oko", "Postać porusza się bezszelestnie", "Postać Wystrzeliwuje serię strzał", "Postać skaczę wysoko", "Postać widzi na znaczną odległość", 5, 5, 5, 5, 120, 40, "Karol", "Bow" });
        }
